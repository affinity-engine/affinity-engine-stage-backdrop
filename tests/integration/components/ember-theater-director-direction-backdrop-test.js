...
moduleForComponent('ember-theater-director-direction-backdrop', 'Integration | Component | ember theater director direction backdrop', {
  integration: true,
...
configurablePriority.forEach((priority) => {
  test(`imageElement is assigned by priority ${priority}`, function(assert) {
    ...
    this.render(hbs`{{ember-theater-director-direction-backdrop directable=directable config=config}}`);
  ...
  test(`caption is assigned by priority ${priority}`, function(assert) {
    ...
    this.render(hbs`{{ember-theater-director-direction-backdrop directable=directable config=config translator=translator}}`);
...
test('alt is set by the fixture id if no caption is present', function(assert) {
  ...
  this.render(hbs`{{ember-theater-director-direction-backdrop directable=directable translator=translator}}`);
